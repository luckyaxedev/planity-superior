...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="container mx-auto px-4 pt-32 pb-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link 
              href="/business" 
              className="bg-black text-white px-8 py-4 font-medium border-2 border-white hover:bg-white hover:text-black transition-colors"
            >
              For Businesses
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-12">
          {[
            ...
            <div key={i} className="text-center">
              <feature.icon className="w-12 h-12 mx-auto mb-4 text-white" strokeWidth={1.5} />
      ...
      {/* CTA */}
      <section className="container mx-auto px-4 py-24 text-center border-t border-gray-800">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-5xl font-bold mb-6">Ready to Get Started?</h2>
          <p className="text-xl text-gray-400 mb-8">Join thousands of happy customers</p>
          <Link 
            href="/search" 
